            ...
            <div className="bg-white">
                ...
                >
                    <div className="lg:text-center">
                        ...
                        <p
                            className="mt-4 max-w-3xl text-xl text-gray-600 lg:mx-auto font-semibold"
                        >
                    ...
                    >
                        ...
                        >
                            ...
                            <div
                                className="col-span-1 flex flex-col justify-center py-8 px-8 bg-gray-50 hidden"
                            >
                                <a
                            ...
                            >
                                ...
                                <a
                                    ...
                                    rel="noreferrer"
                                >
                                    <p className="mt-5 text-center text-gray">Gitcoin</p>
                                </a>
                            </div>
                            <div
                                className="col-span-1 flex flex-col justify-center py-8 px-8 bg-gray-50"
